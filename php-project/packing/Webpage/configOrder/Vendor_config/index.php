...
<body>
    ...
    <div class="container">
        ...
        <div style="margin-bottom: 10%;">
                        ...
                        <div class="modal-body" id="">
                            ...
                            <form action="" id="form-vendor">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="add_name_vendor" placeholder="Enter vender name">
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="recipient-name" class="col-form-label">Vendor Tel</label>
                                    <input type="text" class="form-control" id="add_tel_vendor" placeholder="Enter vender tel">
                                </div>
                                <br>
                            </form>
                        </div>
            ...
            <!-- popup Edit category -->
            <div class="modal fade" id="edit-category" tabindex="-1" role="dialog" aria-labelledby="editCategory"
                aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <form id="edit-category">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label for="recipient-name" class="col-form-label">Vendor Name</label>
                                        <input type="text" class="form-control" id="edit_name_vendor" placeholder="Enter vender name">
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label for="recipient-name" class="col-form-label">Vendor Tel</label>
                                        <input type="text" class="form-control" id="edit_tel_vendor" placeholder="Enter vender tel">
                                    </div>
                                    <br>
                                </div>
                                <br>
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                                        id="update-vendor">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <!-- Delete confirm -->
            <div class="modal fade" id="delete_confirm_vendor" tabindex="-1" role="dialog"
            ...
            <table class="table table-striped table-bordered table-hover" style="text-align: center;" id="vendor_table">
