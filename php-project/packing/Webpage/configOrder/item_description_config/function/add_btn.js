function send_item() {
  var data_select = {
    ...
    "sections": "*",
    "condition": "",
    "sorted": "ORDER BY item_id DESC FETCH FIRST 1 ROWS ONLY",
    "header_fm": "",
    "value_fm": ""
  }
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      function id_item() {
        ...
        var id_text = item[0].item_id
        var number_id = parseInt(id_text.substring(2))
        var sumnumber = number_id + 1
        var countString = sumnumber.toString().padStart(4, '0');
        return 'IT' + countString
      }


      //รับค่าจาก form add
      var item_name = $('input[name=item-name]').val();
      var flag = $('select[name=option-flag-item]').val();

      if (item_name != "") {
        var num_id = id_item()
        var text_value = "(" + "'" + num_id + "'" + "," + "'" + item_name + "'" + "," + "'" + flag + "'" + ")"
        ...
        data_insert_item = {
          ...
          "condition": "",
          "sorted": "",
          "header_fm": "(item_id, item_name, flag)",
          "value_fm": text_value
        }
        ...
        $.ajax({
          ...
          dataType: "json",
          contentType: "application/json; charset=utf-8",
          data: JSON.stringify(data_insert_item),
        ...
        $('<div class="alert alert-danger d-flex align-items-center" role="alert" style="position: fixed; z-index: 1; margin-left:78%; width:20%;">' +
          ...
          'please enter item description name. </div>').appendTo('.AlertTEST');
    ...
    error: function () {
      ...
      if (item_name != "") {
        var text_value = "(" + "'" + "IT0001" + "'" + "," + "'" + item_name + "'" + "," + "'" + flag + "'" + ")"
        ...
        $.ajax({
          ...
          dataType: "json",
          contentType: "application/json; charset=utf-8",
          data: JSON.stringify(data_item_IT0001),
