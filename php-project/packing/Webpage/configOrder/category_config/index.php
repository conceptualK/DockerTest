...
<body>
    ...
    <div class="container">
        ...
        <div style="margin-bottom: 10%;">
                        ...
                        <div class="modal-body" id="">
                            ...
                            <form action="" id="form-category">
                                ...
                                <div class="input-group mb-3">
                                    <select class="form-select" id="inputGroupSelect02" name="option-flag">
                        ...
                        <div class="modal-body">
                            <form id="edit-category">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="edit-category-name"
                                            name="edit-category-name" placeholder="Enter Category name">
                                    </div>
                                    <br>
                                    <label for="editName">Flag</label>
                                    <select class="form-select" id="option-category" name="option-category">
                                        <!-- <option value="">None</option> -->
                                        <option value="T">True</option>
                                        <option value="F">False</option>
                                    </select>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                                        id="update-category">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <!-- Delete confirm -->
            <div class="modal fade" id="delete_confirm_category" tabindex="-1" role="dialog"
            ...
            <table class="table table-striped table-bordered table-hover" style="text-align: center;" id="category">
