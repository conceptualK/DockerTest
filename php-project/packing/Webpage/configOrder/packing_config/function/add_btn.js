function send_packing_style() {
  var data_select = {
    "table": "config_packing_style",
    "operation": "select",
    "sections": "*",
    "condition": "",
    "sorted": "order by style_id desc limit 1",
    "header_fm": "",
    "value_fm": ""
  }
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      function id_style() {
        ...
        var id_text = item[0].style_id
        var number_id = parseInt(id_text.substring(2))
        var sumnumber = number_id + 1
        var countString = sumnumber.toString().padStart(4, '0');
        return 'st' + countString
      }
     


      //รับค่าจาก form add
      var style_name = $('input[name=style-name]').val();
      var flag = $('select[name=option-flag-packing]').val();

      if (style_name != "") {
        var num_id = id_style()
        var text_value = "(" + "'" + num_id + "'" + "," + "'" + style_name + "'" + "," + "'" + flag + "'" + ")"
        ...
        data_packing = {
          ...
          "condition": "",
          "sorted": "",
          "header_fm": "(style_id, style_name, flag)",
          "value_fm": text_value
        }
    ...
    error: function () {
      ...
      if (style_name != "") {
        var text_value = "(" + "'" + "st0001" + "'" + "," + "'" + style_name + "'" + "," + "'" + flag + "'" + ")"
        ...
        $.ajax({
          ...
          dataType: "json",
          contentType: "application/json; charset=utf-8",
          data: JSON.stringify(data_style_st0001),
