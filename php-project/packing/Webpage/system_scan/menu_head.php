...
<header class="p-3 mb-3 bg-white border-bottom" style="box-shadow: 0 0 10px rgba(20, 5, 10, 20);">
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <ul id="show_menu" class="dropdown-menu shadow w-220px" data-bs-theme="dark" style="margin-top:2%;">
          <li><a class="dropdown-item d-flex" href="\packing/Webpage/configOrder/category_config/category.php">Category config</a></li>
          <li><a class="dropdown-item d-flex" href="\packing/Webpage/configOrder/invoice_config/invoice.php">Invoice config</a></li>
          <li><a class="dropdown-item d-flex" href="\packing/Webpage/configOrder/item_description_config/item_description.php">Item description config</a></li>
          <li><a class="dropdown-item d-flex" href="\packing/Webpage/configOrder/packing_config/packing.php">Packing config</a></li>
          <li><a class="dropdown-item d-flex" href="\packing/Webpage/configOrder/Vendor_config/vendor.php">Vendor config</a></li>
        ...
        <ul id="show_scan" class="dropdown-menu shadow w-220px" data-bs-theme="dark" style="margin-top:2%; left:34.5%;">
          <li><a class="dropdown-item d-flex" href="../quality">Quality</a></li>
          <li><a class="dropdown-item d-flex" href="../warehouse">Ware house</a></li>
          <li><a class="dropdown-item d-flex" href="../delivery">Delivery</a></li>
        </ul>
